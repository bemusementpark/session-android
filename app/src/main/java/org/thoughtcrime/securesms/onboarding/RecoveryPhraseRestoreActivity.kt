...
class RecoveryPhraseRestoreActivity : BaseActionBarActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.termsTextView.text = SpannableStringBuilder("By using this service, you agree to our Terms of Service and Privacy Policy")
        ...
        binding.termsTextView.setOnClickListener { showTermsOfServiceDialog() }
    }
    // endregion
    ...
    private fun restore() {
        ...
        try {
            ...
            push(Intent(this, DisplayNameActivity::class.java))
        } catch (e: Exception) {
