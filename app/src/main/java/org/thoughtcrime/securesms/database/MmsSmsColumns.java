...
public interface MmsSmsColumns {
  ...
  public static class Types {
    ...
    protected static final long[] OUTGOING_MESSAGE_TYPES = {BASE_OUTBOX_TYPE, BASE_SENT_AND_SYNCED_TYPE,
                                                            BASE_SYNCING_TYPE, BASE_SYNC_FAILED_TYPE,
    ...
    public static boolean isSyncing(long type) {
